...
public class GroupTaskAdapter extends FragmentPagerAdapter {
   ...
   /* private final List<Fragment> mFragmentList = new ArrayList<>();
    ...
    public GroupTaskAdapter(Context context, FragmentManager fm, String source, String groupmember, String groupname, String al) {
        super(fm);
        mContext = context;
        this.source = source;
...
*/
    ...
    public CharSequence getPageTitle(int position) {
        String title = null;
       if (position == 0 && source.equalsIgnoreCase("task")) {
            title = "View Task";
        } else if (position == 1 && source.equalsIgnoreCase("task")) {
            title = "Assign Task";
        }
