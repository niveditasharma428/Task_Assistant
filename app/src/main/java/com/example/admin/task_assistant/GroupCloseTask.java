    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  Bundle bundle=getIntent().getExtras();
       ...
       // txt2 = (TextView) findViewById(R.id.txt2);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, PROFILE_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(GroupCloseTask.this, response, Toast.LENGTH_LONG).show();
                }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(GroupCloseTask.this, error.toString(), Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(GroupCloseTask.this);
